...
angular.module('gyeTask.admin.services',[]);
  ...
  .factory('Auth', function (FURL, $firebaseAuth, $firebase) {
    ...
    var Auth = {
      ...
      register: function (user) {
        ...
        .then(function () {
          return Auth.login(user);//Authenticate to have write permission
        })
        .then(function (data) {
          return Auth.createProfile(data.uid, user);//store user data in Firebase after creating account
        });
      },
